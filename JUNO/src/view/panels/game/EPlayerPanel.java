...
/**
 * Rappresenta il panel del giocatore artificiale nella posizione piu' a sinistra.
 */
public class EPlayerPanel extends PlayerPanel {

    /**
     * Costruttore del panel del giocatore.
     * @param color il colore del tavolo
     */
    public EPlayerPanel(Color color) {
        super("Waluigi", "./src/graphics/op3.png", color);
        GridBagConstraints gbc = new GridBagConstraints();

        cardImage = new ImageIcon(new ImageIcon("./src/graphics/back-card-e.png")
