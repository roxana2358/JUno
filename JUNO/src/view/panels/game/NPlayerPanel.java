...
/**
 * Rappresenta il panel del giocatore piu' vicino al bordo superiore.
 */
public class NPlayerPanel extends PlayerPanel {

    /**
     * Costruttore del panel del giocatore.
     * @param color il colore del tavolo
     */
    public NPlayerPanel(Color color) {
        super("Wario", "./src/graphics/op2.png", color);
        GridBagConstraints gbc = new GridBagConstraints();

        cardImage = new ImageIcon(new ImageIcon("./src/graphics/back-card-n.png")
